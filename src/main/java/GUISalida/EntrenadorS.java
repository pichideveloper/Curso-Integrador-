 ...
 * @author frixi
 */
public class EntrenadorS extends javax.swing.JFrame {
Integer xMouse,yMouse;
    ...
    public void mostrar(JTable tabla){
        String sql="Select * from TablaEntrenadores"; 
        Statement st;
    ...
    if (eliminado) {
        ...
        logDAO.insertarLog("Eliminación Entrenador", "ID: " + id);
    ...
    private void eliminarTodo() {
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ...
            if (eliminado) {
                ...
                LogCC logDAO = new LogCC();
                logDAO.insertarLog("Eliminación Total Entrenadores", "Se borraron todos los registros");
...
private void actualizarDato() {
    ...
    if (actualizado) {
        LogCC logDAO = new LogCC();
        logDAO.insertarLog("Actualización Entrenador", "ID: " + id + ", Campo: " + columna + ", Nuevo valor: " + nuevoValor);
...
private void exportarPDF() {
    ...
    private void initComponents() {
        ...
        bg.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 200, 460));
        ...
        tablaEntrenadores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DNI", "Nombre", "Apellido", "Edad", "Deporte", "Sueldo", "Tiempo (años)", "Sueldo_Final"
            }
        ) {
        ...
        jLabel1.setText("Tabla Entrenadores");
        ...
        bg.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 760, 390));

        jPanel4.setBackground(new java.awt.Color(197, 161, 115));
        ...
        bg.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 390, 760, 70));
        ...
        bg.add(head1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 960, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntrenadorS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EntrenadorS().setVisible(true);
            }
        });
    }
